...
- 已完成：Ch01 / Ch02 / Ch03（用户 2026-09-14 确认）
- 下一章：Ch04 Spring AI 进阶（RAG / MCP / 可观察性）
- 备注：Ch03 在仓库里的 `spring-ai/stateful-agent/` 目前还是空目录，
  后续开工 Ch04 前建议先核对 Ch03 的代码和文档是否真的落盘。
